...
parser.add_argument('--eval_every_epochs', type=str, default='30')
...
def main():
    ...
    valid_queue = torch.utils.data.DataLoader(valid_data, batch_size=args.eval_batch_size, pin_memory=True,
                                              num_workers=16)
    
    # Train child model
    assert args.arch_pool is not None
